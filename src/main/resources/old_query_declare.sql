 ...
 select cast(wr.Webrate_GenerationDate_temp AS DATE) AS Occupancy_DT, wr.Webrate_Channel_ID, wr.Webrate_Competitors_ID, wr.Webrate_RateValue_Display 
                 ...
                 ( 
                      select wr.*,calendar_date as webrate_generationDate_temp from PACE_Webrate_Differential as wr 
                              ...
                              WHERE wr.Occupancy_DT = @selectedDate AND wr.LOS= @los AND wr.Webrate_Status = 'A' 
                      ...
                      and cal.calendar_date between @startDt and @endDt
                 )AS wr 
                 INNER JOIN Webrate_Accom_Class_Mapping wacm ON wr.Webrate_Accom_Type_ID = wacm.Webrate_Accom_Type_ID and wacm.Accom_Class_ID= @accomClassId
                 ...
                 INNER JOIN Webrate_Competitors_Class AS  wcc ON wcc.Webrate_Competitors_ID = wr.Webrate_Competitors_ID and wcc.Demand_Enabled = 1 and wcc.Accom_Class_ID = @accomClassId and wcc.Product_ID = 1
                 ...
                 ( 
                       ...
                       ( 
                               ...
                               WHERE cast(cal.calendar_date AS date) between @startDt and @endDt
                       ) as channelbyDate 
...
--DROP TABLE #pace_webrate_differential
